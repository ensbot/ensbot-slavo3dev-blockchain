...
## Enum or Enumerator data type, allows user to defined data types with limited set of meaningful values. It is mostly used for internal use and are not supported currency at the ABI level of Solidity.
